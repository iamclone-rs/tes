...
def loss_fn(args, model, features, mode='train'):
    ...
    xmodal_weight = float(getattr(args, "xmodal_weight", 1.0))

    return 10 * loss_triplet + alpha * loss_cls + 2 * loss_distill + beta * loss_cjs + xmodal_weight * loss_xmodal
